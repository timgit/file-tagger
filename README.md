...
#Installation#
You can either include /src/Render.cs into your ASP.NET MVC project directly or use the NuGet package I created to keep it as an externally versioned  dependency.
